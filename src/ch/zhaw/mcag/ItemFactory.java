...
public class ItemFactory {
	...
	public static Enemy createEnemy(){
		...
		int y = (int)(Math.random() * Config.getBOARD_DIMESION().getHeight()) - imageIcon.getIconHeight();
		int x = Config.getBOARD_DIMESION().getLength() - imageIcon.getIconWidth();
	...
	public static Shot createShot(Creature creature){
		...
		Dimension dimension = new Dimension(imageIcon.getIconHeight(), imageIcon.getIconWidth());
		Position position = new Position(creature.getPosition().getX(), creature.getPosition().getY());
		return new Shot(position, dimension, imageIcon.getImage());
	}
}
