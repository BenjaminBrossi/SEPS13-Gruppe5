...
public class Menu {
	...
	public void showMainMenu(Graphics2D g2d) {
		...
		g2d.drawString("Name ändern", Config.getBoardDimension().getLength() / 2 - 100, 300);
		g2d.drawString("Level auswählen", Config.getBoardDimension().getLength() / 2 - 100, 350);
	...
	public void showLevelMenu(Graphics2D g2d) {
		g2d.drawString("MCAG", Config.getBoardDimension().getLength() / 2 - 100, 200);
		g2d.drawString("Level wählen: ", Config.getBoardDimension().getLength() / 2 - 100, 250);
	}
	...
	private void select(int selected) {
		...
		case 3:
			state = 3;
			break; // Level auswählen
		case 4:
			break; // Controller einstellen
		case 5:
			break; // Highscore
		case 6:
